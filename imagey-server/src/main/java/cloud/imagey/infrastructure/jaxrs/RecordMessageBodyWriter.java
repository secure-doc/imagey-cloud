...
public class RecordMessageBodyWriter extends AbstractRecordMessageBodyWriter implements MessageBodyWriter<Record> {
    ...
    public void writeTo(Record t, Class<?> type, Type genericType, Annotation[] annotations, MediaType mediaType,
        ...
        Object result = write(t);
        providers.getMessageBodyWriter((Class<Object>)result.getClass(), result.getClass(), annotations, mediaType)
