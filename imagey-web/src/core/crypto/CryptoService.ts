...
export const cryptoService = {
  ...
  decryptPrivatePasswordKey: async (
    ...
    try {
      ...
      throw new SecureDocError("Failed to decrypt private password key", SecureDocErrorCode.DECRYPTION_FAILED, e);
    }
  },
  ...
  decryptKey: async (
    ...
    try {
      ...
      throw new SecureDocError("Failed to decrypt key", SecureDocErrorCode.DECRYPTION_FAILED, e);
    }
  },
  ...
  decryptDocument: async (
    ...
    try {
      const cryptoKey = await importSymmetricKey(key);
      return await decryptAESGCM(content, cryptoKey);
    } catch (e) {
      throw new SecureDocError("Failed to decrypt document", SecureDocErrorCode.DECRYPTION_FAILED, e);
    }
  },
  ...
  decryptMessage: async (
    ...
    try {
      ...
      throw new SecureDocError("Failed to decrypt message", SecureDocErrorCode.DECRYPTION_FAILED, e);
    }
  },
