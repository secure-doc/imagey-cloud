...
export function useFolderIcons(folderId: string, folderKey: JsonWebKey | undefined, onCreateFolder: () => void, onDocumentUploaded: (document: DocumentMetadata) => void) {
  ...
  const actionIcons = useMemo(() => {
    ...
    return icons;
  }, [t, parentId, folderId, documentsId, folderKey, navigate, onCreateFolder, onDocumentUploaded]);
