...
export const marysPublicMainKey: JsonWebKey = {
  crv: "P-256",
  ext: true,
  key_ops: [],
  kty: "EC",
...
export const marysPrivateMainKey: JsonWebKey = {
  crv: "P-256",
...
export const marysSecondPublicDeviceKey: JsonWebKey = {
  key_ops: [],
  ext: true,
  kty: "EC",
...
export const marysEncryptedPrivateMainKeyForSecondDevice =
